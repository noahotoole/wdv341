...
//Model-Controller Area.  The PHP processing code goes in this area. 
	...
	$inGender = $_POST["gender"];			//Get the value entered in the gender field
	$inNewsletter = $_POST["newsletter"];	//Get the value entered in the newsletter field
	$inGrade = $_POST["grade"];				//Get the value entered in the grade field
...
<p>Newsletter: <?php echo $inNewsletter; ?></p>
<p>Grade: <?php echo $inGrade; ?></p>
